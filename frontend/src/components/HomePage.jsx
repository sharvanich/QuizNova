...
function HomePage({ onCategorySelect }) {
  ...
  const funFacts = [
    ...
    "🐙 Octopuses have three hearts and blue blood, making them truly alien-like creatures!",
    "🌱 A single tree can absorb up to 48 pounds of CO2 per year and produce enough oxygen for two people.",
    "⭐ The light from some stars we see tonight started its journey before humans existed on Earth.",
    "🧬 You share about 60% of your DNA with bananas - we're more connected to nature than we think!",
    "🌊 The ocean produces over 70% of Earth's oxygen, not trees as commonly believed.",
    "🦋 Butterflies taste with their feet and smell with their antennae.",
    "💫 Honey never spoils - archaeologists have found edible honey in ancient Egyptian tombs!",
    "🎵 Music can trigger the release of dopamine, the same chemical released when eating or falling in love."
  ]
  ...
  const handleSearchSubmit = (e) => {
    ...
    if (searchQuery.trim()) {
      ...
      onCategorySelect({
        ...
        icon: '🔍', // Search icon for custom topics
        topic: topicName
      })
    }
  }
    ...
    <div className="homepage">
      {showAbout && (
        <>
          ...
          <div className="modal-section">
            ...
            <h2>About Us</h2>
            <p>Welcome to your smart AI-powered quiz companion! Here, quizzes aren't just static questions—they're dynamically generated by cutting-edge AI to challenge your brain, sharpen your skills, and make learning fun.</p>
            ...
            <p>Join us to explore, learn, and level up—one smart quiz at a time!</p>
          </div>
        </>
      )}
      ...
      {showFunFacts && (
        <>
          ...
          <div className="modal-section">
            <button className="close-btn" onClick={() => setShowFunFacts(false)}>×</button>
            <h2>🎯 Fun Facts to Spark Your Curiosity</h2>
